...
func (q *Queries) Complicated(ctx context.Context, n int32) (*int32, error) {
	return _Complicated(ctx, q.AsReadOnly(), n)
}

func (q *ReadOnlyQueries) Complicated(ctx context.Context, n int32) (*int32, error) {
	return _Complicated(ctx, q, n)
}

func _Complicated(ctx context.Context, q CacheQuerierConn, n int32) (*int32, error) {
	qctx, cancel := context.WithTimeout(ctx, time.Millisecond*1000)
	defer cancel()
	q.GetConn().CountIntent("users.Complicated")
	dbRead := func() (any, time.Duration, error) {
		cacheDuration := time.Duration(time.Millisecond * 60000)
		row := q.GetConn().WQueryRow(qctx, "users.Complicated", complicated, n)
	...
	var x *int32
	err := q.GetCache().GetWithTtl(qctx, "users:Complicated:"+hashIfLong(fmt.Sprintf("%+v", n)), &x, dbRead, false, false)
	if err != nil {
		return nil, err
	}
...
func (q *Queries) CreateUser(ctx context.Context, arg CreateUserParams, getUserByID *int32, getUserByName *string) (*User, error) {
	return _CreateUser(ctx, q, arg, getUserByID, getUserByName)
}

func _CreateUser(ctx context.Context, q CacheWGConn, arg CreateUserParams, getUserByID *int32, getUserByName *string) (*User, error) {
	qctx, cancel := context.WithTimeout(ctx, time.Millisecond*1000)
	defer cancel()
	row := q.GetConn().WQueryRow(qctx, "users.CreateUser", createUser, arg.Name, arg.Metadata, arg.Image)
	var i *User = new(User)
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func _GetUserByID(ctx context.Context, q CacheQuerierConn, id int32) (*User, error) {
	qctx, cancel := context.WithTimeout(ctx, time.Millisecond*1000)
	defer cancel()
	q.GetConn().CountIntent("users.GetUserByID")
	dbRead := func() (any, time.Duration, error) {
		cacheDuration := time.Duration(time.Millisecond * 30000)
		row := q.GetConn().WQueryRow(qctx, "users.GetUserByID", getUserByID, id)
		var i *User = new(User)
		err := row.Scan(
			&i.ID,
			&i.Name,
	...
	var i *User
	err := q.GetCache().GetWithTtl(qctx, "users:GetUserByID:"+hashIfLong(fmt.Sprintf("%+v", id)), &i, dbRead, false, false)
	if err != nil {
		return nil, err
	}
...
func (q *Queries) GetUserByName(ctx context.Context, name string) (*User, error) {
	return _GetUserByName(ctx, q.AsReadOnly(), name)
}

func (q *ReadOnlyQueries) GetUserByName(ctx context.Context, name string) (*User, error) {
	return _GetUserByName(ctx, q, name)
}

func _GetUserByName(ctx context.Context, q CacheQuerierConn, name string) (*User, error) {
	qctx, cancel := context.WithTimeout(ctx, time.Millisecond*1000)
	defer cancel()
	q.GetConn().CountIntent("users.GetUserByName")
	dbRead := func() (any, time.Duration, error) {
		cacheDuration := time.Duration(time.Millisecond * 300000)
		row := q.GetConn().WQueryRow(qctx, "users.GetUserByName", getUserByName, name)
		var i *User = new(User)
		err := row.Scan(
			&i.ID,
			&i.Name,
	...
	var i *User
	err := q.GetCache().GetWithTtl(qctx, "users:GetUserByName:"+hashIfLong(fmt.Sprintf("%+v", name)), &i, dbRead, false, false)
	if err != nil {
		return nil, err
	}
...
func (q *Queries) IncorrectQuery(ctx context.Context, namePointer *string) (*User, error) {
	return _IncorrectQuery(ctx, q.AsReadOnly(), namePointer)
}

func (q *ReadOnlyQueries) IncorrectQuery(ctx context.Context, namePointer *string) (*User, error) {
	return _IncorrectQuery(ctx, q, namePointer)
}

func _IncorrectQuery(ctx context.Context, q CacheQuerierConn, namePointer *string) (*User, error) {
	qctx, cancel := context.WithTimeout(ctx, time.Millisecond*1000)
	defer cancel()
	q.GetConn().CountIntent("users.IncorrectQuery")
	dbRead := func() (any, time.Duration, error) {
		cacheDuration := time.Duration(time.Millisecond * 300000)
		row := q.GetConn().WQueryRow(qctx, "users.IncorrectQuery", incorrectQuery, namePointer)
		var i *User = new(User)
		err := row.Scan(
			&i.ID,
			&i.Name,
	...
	var i *User
	err := q.GetCache().GetWithTtl(qctx, "users:IncorrectQuery:"+hashIfLong(fmt.Sprintf("%+v", ptrStr(namePointer))), &i, dbRead, false, false)
	if err != nil {
		return nil, err
	}
...
func (q *Queries) ListUserNames(ctx context.Context, arg ListUserNamesParams) ([]ListUserNamesRow, error) {
	return _ListUserNames(ctx, q.AsReadOnly(), arg)
}

func (q *ReadOnlyQueries) ListUserNames(ctx context.Context, arg ListUserNamesParams) ([]ListUserNamesRow, error) {
	return _ListUserNames(ctx, q, arg)
}

func _ListUserNames(ctx context.Context, q CacheQuerierConn, arg ListUserNamesParams) ([]ListUserNamesRow, error) {
	qctx, cancel := context.WithTimeout(ctx, time.Millisecond*1000)
	defer cancel()
	q.GetConn().CountIntent("users.ListUserNames")
	rows, err := q.GetConn().WQuery(qctx, "users.ListUserNames", listUserNames, arg.After, arg.First)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func _ListUsers(ctx context.Context, q CacheQuerierConn, arg ListUsersParams) ([]User, error) {
	qctx, cancel := context.WithTimeout(ctx, time.Millisecond*1000)
	defer cancel()
	q.GetConn().CountIntent("users.ListUsers")
	rows, err := q.GetConn().WQuery(qctx, "users.ListUsers", listUsers, arg.After, arg.First)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) UpdateNameByID(ctx context.Context, arg UpdateNameByIDParams) (*int32, error) {
	return _UpdateNameByID(ctx, q.AsReadOnly(), arg)
}

func _UpdateNameByID(ctx context.Context, q CacheQuerierConn, arg UpdateNameByIDParams) (*int32, error) {
	qctx, cancel := context.WithTimeout(ctx, time.Millisecond*1000)
	defer cancel()
	row := q.GetConn().WQueryRow(qctx, "users.UpdateNameByID", updateNameByID, arg.Name, arg.ID)
